                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="mapouter">
                        <div class="gmap_canvas">
                            <iframe width="1008" height="659" id="gmap_canvas" src="https://maps.app.goo.gl/FmtMeQxDArtfLxcx8" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                        </div>
                    </div>
                </div>
